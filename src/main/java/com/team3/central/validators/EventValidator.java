...
public class EventValidator {
  ...
  public void validateEventForm(EventForm eventForm) throws IllegalArgumentException {
    ...
    if (eventForm.getName() == null || eventForm.getName().length() < 1) {
      throw new IllegalArgumentException("Event name cannot be null or empty");
    }
    if (eventForm.getTitle() == null || eventForm.getTitle().length() < 1) {
      throw new IllegalArgumentException("Event title cannot be null or empty");
    }
    if (eventForm.getPlaceSchema() == null || eventForm.getPlaceSchema().length() < 1) {
    ...
    if (eventForm.getLatitude() == null || eventForm.getLongitude() == null) {
      throw new IllegalArgumentException("Event latitude and longitude cannot be null");
    }
  }
